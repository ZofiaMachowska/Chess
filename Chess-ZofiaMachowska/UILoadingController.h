...
public:
    ...
    int gameToLoadNext = -1; ///< The index of the game that will be loaded next. Initialized to -1 to indicate no selection.
...
private:
    ...
    std::vector<Game> gamesLoading; ///< Vector storing saved game data.
