 ...
 * @brief Class for controlling the behavior of a knight in a chess game.
 *
 * Provides the functionalities specific to a knight, like determining its valid moves and checking if it can capture the opponent's king.
 */
...
public:
     ...
     * @param isWhite Flag to determine if the knight is white.
    ...
    const int VALUE = 3; /**< Value assigned to the knight for gameplay purposes. */
};
