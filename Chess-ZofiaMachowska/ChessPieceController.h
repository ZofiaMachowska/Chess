 ...
 * @brief Abstract class defining common functionalities for chess pieces.
 *
...
public:
     ...
     * @param isWhite Flag to determine if the piece is white.
    ...
    const int BOARD_LENGTH = 7; /**< Defines the length of the chess board. */
};
